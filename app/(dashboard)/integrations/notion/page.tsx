    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="p-4 rounded-xl bg-mv-cream-soft border border-mv-border space-y-3">
        ...
        <ol className="space-y-2 text-xs text-mv-ink-soft list-decimal list-inside leading-relaxed">
          ...
          <li>Cliquez <strong>+ New integration</strong>, nommez-la "Minerva Centurions"</li>
          ...
          <li>Dans vos pages Notion, cliquez <strong>...</strong> → <strong>Connections</strong> → ajoutez "Minerva Centurions"</li>
        </ol>
      </div>

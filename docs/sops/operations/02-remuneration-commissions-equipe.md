...
- **Règles d'or** : Qualifier scrupuleusement les besoins du restaurant avant de transférer au fondateur ; tenir le CRM à jour après chaque échange.

### 🧑‍💼 Fiche Account Manager :
- **KPIs cibles** : Satisfaction client (NPS > 8/10), Taux de rétention à 90 jours (> 80%), Délai de réponse client (< 24h ouvrées).
- **Règles d'or** : Conduire un check-in structuré hebdomadaire (15-20 min) avec chaque client actif ; identifier proactivement les opportunités d'upsell (Minerva Flow, Reach, packs vidéo).

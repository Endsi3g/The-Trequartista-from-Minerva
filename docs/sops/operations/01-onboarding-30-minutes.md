...
- **La vision du fondateur :** Minerva (le fondateur) se concentre sur la programmation et la stratégie (la tête qui réfléchit). L'équipe exécute. Chaque membre est autodidacte, autonome et maîtrise son rôle.
...
- **Proactivité** : Tu vois un problème, tu proposes une solution concrète.
- **Rigueur** : Le CRM et les tâches sont toujours à jour. Pas de « j'ai oublié ».
- **Communication transparente** : Si tu es bloqué, signale-le immédiatement. Pas de silence radio.

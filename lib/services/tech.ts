...
export const STANDARD_20_POINT_QC: TechQaPoint[] = [
  ...
  // ── 3. Architecture & Robustesse (4 points) ──
  {
    ...
    description: 'Fallbacks locaux en cas de coupure Supabase ou API tierce pour garantir zéro écran blanc.',
    passed: false,
    critical: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Vérification de signature HMAC sur les webhooks ElevenLabs, Stripe et Framer.',
    passed: false,
    critical: false,
  },
  {

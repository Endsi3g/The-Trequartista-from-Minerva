...
-- Insertion idempotente de la SOP-DEV-03 (The 6-Step Loop)
INSERT INTO public.academy_sops (
  title, description, category, target_workspace, content_markdown, read_time_min, author, is_essential, is_featured, is_onboarding_step, sort_order, pillar, checklist_items, script_template
)
SELECT
  'SOP-DEV-03 : Implémenter une Fonctionnalité Minerva (The 6-Step Loop)',
  'Protocole d’ingénierie pas-à-pas pour implémenter de nouvelles fonctionnalités : Schéma Supabase & RLS, Typage TypeScript strict, Service data, UI tokens 1px et App Router.',
  'Tech & Ingénierie',
  'tech',
  '# SOP-DEV-03 — Guide Pratique : Implémenter une Fonctionnalité Minerva (The 6-Step Loop)
...
```',
  ...
  '// 1. Initialiser la branche de travail dédiée
git checkout main && git pull origin main
...
-- ============================================================================
-- TECH EDGE INVOCATIONS (Audit des fonctions Edge Supabase)
-- ============================================================================
...
CREATE POLICY "Authenticated users can read tech_edge_invocations"
    ON public.tech_edge_invocations FOR SELECT TO authenticated USING (true);
...
CREATE POLICY "Authenticated users can insert tech_edge_invocations"
    ON public.tech_edge_invocations FOR INSERT TO authenticated WITH CHECK (true);

-- ============================================================================
-- FIN DU MASTER SCRIPT CONSOLIDÉ (v2.30.9)
-- ============================================================================

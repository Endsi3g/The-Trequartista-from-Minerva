...
const SAMPLE_REACH_DATA = [
  {
    ...
    notes: 'Recherche un écosystème de fidélisation pour réactiver ses habitués et protéger les marges en cuisine avec commande directe 0%.',
    rating: 4.6,
    reviews_count: 142,
  },
  {
    ...
    notes: 'Volume de commandes à emporter très élevé (80+ pizzas/jour). Souhaite un programme de fidélité et de commande directe pour maximiser sa marge nette.',
    rating: 4.7,
    reviews_count: 310,
  },
  {

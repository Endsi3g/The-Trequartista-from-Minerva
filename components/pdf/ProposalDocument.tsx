...
const styles = StyleSheet.create({
  ...
  header: { marginBottom: 24, borderBottom: '2 solid #059669', paddingBottom: 12 },
  brand: { fontSize: 18, fontFamily: 'Helvetica-Bold', color: '#059669' },
  tagline: { fontSize: 9, color: '#71717a', marginTop: 2 },
  h1: { fontSize: 16, fontFamily: 'Helvetica-Bold', marginTop: 20, marginBottom: 4 },
  h2: { fontSize: 12, fontFamily: 'Helvetica-Bold', marginTop: 16, marginBottom: 8, color: '#059669' },
  para: { fontSize: 10, lineHeight: 1.5, marginBottom: 6 },
  quote: { fontSize: 9, fontStyle: 'italic', color: '#71717a', marginBottom: 4, paddingLeft: 8, borderLeft: '2 solid #a7f3d0' },
  row: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, borderBottom: '0.5 solid #e4e4e7' },
  rowLabel: { fontSize: 9, color: '#71717a' },
  ...
  totalValue: { fontSize: 14, fontFamily: 'Helvetica-Bold', color: '#059669' },
  initiative: { marginBottom: 8, padding: 8, backgroundColor: '#f4f4f5' },
  initiativeTitle: { fontSize: 10, fontFamily: 'Helvetica-Bold' },
  badges: { flexDirection: 'row', gap: 6, marginTop: 4 },
  badge: { fontSize: 8, backgroundColor: '#ecfdf5', color: '#059669', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 },
  footer: { position: 'absolute', bottom: 30, left: 40, right: 40, fontSize: 8, color: '#a1a1aa', textAlign: 'center', borderTop: '0.5 solid #e4e4e7', paddingTop: 8 },
  cta: { marginTop: 24, padding: 14, backgroundColor: '#059669', color: '#ffffff', textAlign: 'center' },
